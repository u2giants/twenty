...
export class OpportunityWorkspaceEntity extends BaseWorkspaceEntity {
  ...
  /** Human-readable prose summary shown in the UI. Derived from aiState. */
  aiSummary: string | null;
  /** Machine-readable JSON state (OpportunityState). Backend only — not displayed directly. */
  aiState: string | null;
  department: EntityRelation<DepartmentWorkspaceEntity> | null;
  departmentId: string | null;
  factory: EntityRelation<FactoryWorkspaceEntity> | null;
  factoryId: string | null;
  licensorApprovalThreads: EntityRelation<
    LicensorApprovalThreadWorkspaceEntity[]
  >;
