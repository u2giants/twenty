...
export const STANDARD_FLAT_OBJECT_METADATA_BUILDERS_BY_OBJECT_NAME = {
  ...
  >) =>
    createStandardObjectFlatMetadata({
      ...
      context: {
        universalIdentifier:
          STANDARD_OBJECTS.aiModelConfig.universalIdentifier,
        ...
        description: i18nLabel(msg`AI model configuration for routing and processing`),
        icon: 'IconRobot',
        isSearchable: true,
        labelIdentifierFieldMetadataName: 'name',
      },
  ...
  department: ({
    ...
    CreateStandardObjectArgs<'department'>,
    'context' | 'objectName'
  >) =>
    createStandardObjectFlatMetadata({
      ...
      context: {
        universalIdentifier:
          STANDARD_OBJECTS.department.universalIdentifier,
  ...
  >) =>
    createStandardObjectFlatMetadata({
      ...
      context: {
        universalIdentifier:
          STANDARD_OBJECTS.emailMessage.universalIdentifier,
  ...
  factory: ({
    ...
    CreateStandardObjectArgs<'factory'>,
    'context' | 'objectName'
  >) =>
    createStandardObjectFlatMetadata({
      objectName: 'factory',
      ...
      context: {
        universalIdentifier:
          STANDARD_OBJECTS.factory.universalIdentifier,
  ...
  ignoreRule: ({
    ...
    CreateStandardObjectArgs<'ignoreRule'>,
    'context' | 'objectName'
  >) =>
    createStandardObjectFlatMetadata({
      ...
      context: {
        universalIdentifier:
          STANDARD_OBJECTS.ignoreRule.universalIdentifier,
        ...
        description: i18nLabel(msg`A subject pattern to auto-skip during email routing`),
        icon: 'IconFilter',
        isSearchable: true,
  ...
  >) =>
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        description: i18nLabel(msg`A licensing submission and approval workflow`),
  ...
  meetingNote: ({
    ...
    CreateStandardObjectArgs<'meetingNote'>,
    'context' | 'objectName'
  >) =>
    createStandardObjectFlatMetadata({
      ...
      context: {
        universalIdentifier:
          STANDARD_OBJECTS.meetingNote.universalIdentifier,
        ...
        description: i18nLabel(msg`A meeting record from Fireflies or manual entry`),
        icon: 'IconNotes',
        isSearchable: true,
        labelIdentifierFieldMetadataName: 'name',
      },
