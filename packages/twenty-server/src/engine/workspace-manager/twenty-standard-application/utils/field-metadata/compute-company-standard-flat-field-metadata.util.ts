...
>): Record<AllStandardObjectFieldName<'company'>, FlatFieldMetadata> => ({
  ...
  customerStatus: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      isNullable: true,
      options: [
        { id: '791e6e9a-71fe-4cc3-86eb-0a870dfe2257', value: 'ACTIVE_CUSTOMER', label: i18nLabel(msg`Active Customer`), position: 0, color: 'green' },
        { id: 'ef499ec1-609f-4168-859d-3cbfbdacc5b4', value: 'POTENTIAL_CUSTOMER', label: i18nLabel(msg`Potential Customer`), position: 1, color: 'yellow' },
        { id: '4d7525e0-8515-4f34-8ebc-fea7332b4c84', value: 'OTHER', label: i18nLabel(msg`Other`), position: 2, color: 'gray' },
        { id: 'a1b2c3d4-e5f6-4a7b-8c9d-0e1f2a3b4c5d', value: 'UNASSIGNED', label: i18nLabel(msg`Unassigned`), position: 3, color: 'red' },
      ],
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
  ...
  chainType: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      isNullable: true,
      options: [
        { id: '84d0952d-8b45-44ec-acc5-4de176c6e87a', value: 'MASS_MARKET', label: i18nLabel(msg`Mass Market`), position: 0, color: 'blue' },
        { id: 'ce5b06eb-c42e-471e-9c04-fdc831c778fc', value: 'OFF_PRICE', label: i18nLabel(msg`Off-Price`), position: 1, color: 'orange' },
        { id: 'de702024-48a4-4112-8cd5-5d4ca58d8658', value: 'SPECIALTY', label: i18nLabel(msg`Specialty`), position: 2, color: 'purple' },
        { id: '9edbc524-68e2-4504-a27e-021816e8cce6', value: 'CLUB', label: i18nLabel(msg`Club`), position: 3, color: 'green' },
        { id: 'ddfc47f0-76f9-4916-a606-b89f49353f05', value: 'DOLLAR', label: i18nLabel(msg`Dollar`), position: 4, color: 'yellow' },
      ],
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
