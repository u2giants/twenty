...
> => ({
  ...
  division: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Business division this member belongs to`),
      icon: 'IconBriefcase',
      isNullable: true,
      defaultValue: "'ALL'",
      options: [
        { id: 'd1', value: 'POP', label: i18nLabel(msg`POP`), position: 0, color: 'blue' },
        { id: 'd2', value: 'SPRUCE', label: i18nLabel(msg`Spruce`), position: 1, color: 'green' },
        { id: 'd3', value: 'ALL', label: i18nLabel(msg`All Divisions`), position: 2, color: 'purple' },
      ],
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
  ...
  primarySalespersonCompanies: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'primarySalespersonCompanies',
      label: i18nLabel(msg`Primary Salesperson Companies`),
      description: i18nLabel(
        msg`Companies where this member is primary salesperson`,
      ),
      icon: 'IconBuildingSkyscraper',
      isNullable: true,
      targetObjectName: 'company',
      targetFieldName: 'primarySalesperson',
      settings: {
        relationType: RelationType.ONE_TO_MANY,
      },
    },
  ...
  mailboxEmails: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'mailboxEmails',
      label: i18nLabel(msg`Mailbox Emails`),
      description: i18nLabel(
        msg`Emails ingested from this member's mailbox`,
      ),
      icon: 'IconMailbox',
      isNullable: true,
      targetObjectName: 'emailMessage',
      targetFieldName: 'mailboxOwner',
      settings: {
        relationType: RelationType.ONE_TO_MANY,
      },
    },
