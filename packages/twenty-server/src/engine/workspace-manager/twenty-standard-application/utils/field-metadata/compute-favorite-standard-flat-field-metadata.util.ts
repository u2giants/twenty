...
>): Record<AllStandardObjectFieldName<'favorite'>, FlatFieldMetadata> => ({
  ...
  // --- POP Creations morph targets ---
  ignoreRule: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'ignoreRule',
      label: i18nLabel(msg`Ignore Rule`),
      description: i18nLabel(msg`Favorite ignore rule`),
      icon: 'IconFilter',
      isSystem: true,
      isNullable: true,
      isUIReadOnly: true,
      targetObjectName: 'ignoreRule',
      targetFieldName: 'favorites',
      settings: {
        relationType: RelationType.MANY_TO_ONE,
        onDelete: RelationOnDeleteAction.SET_NULL,
        joinColumnName: 'ignoreRuleId',
      },
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
  ...
  meetingNoteAttendee: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'meetingNoteAttendee',
      label: i18nLabel(msg`Meeting Note Attendee`),
      description: i18nLabel(msg`Favorite meeting note attendee`),
      icon: 'IconUserCheck',
      isSystem: true,
      isNullable: true,
      isUIReadOnly: true,
      ...
      settings: {
        relationType: RelationType.MANY_TO_ONE,
        onDelete: RelationOnDeleteAction.SET_NULL,
        joinColumnName: 'meetingNoteAttendeeId',
      },
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
  ...
  targetAiModelConfig: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'targetAiModelConfig',
      label: i18nLabel(msg`AI Model Config`),
      description: i18nLabel(msg`Favorite AI model config`),
      icon: 'IconRobot',
      isSystem: true,
      isNullable: true,
      isUIReadOnly: true,
      targetObjectName: 'aiModelConfig',
      targetFieldName: 'favorites',
      settings: {
        relationType: RelationType.MANY_TO_ONE,
        onDelete: RelationOnDeleteAction.SET_NULL,
        joinColumnName: 'targetAiModelConfigId',
      },
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
  ...
  targetDepartment: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      ...
      description: i18nLabel(msg`Favorite department`),
      ...
      settings: {
        relationType: RelationType.MANY_TO_ONE,
        onDelete: RelationOnDeleteAction.SET_NULL,
        joinColumnName: 'targetDepartmentId',
      },
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
  ...
  targetEmailMessage: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'targetEmailMessage',
      label: i18nLabel(msg`Email Message`),
      description: i18nLabel(msg`Favorite email message`),
      icon: 'IconMail',
      isSystem: true,
      isNullable: true,
      isUIReadOnly: true,
      ...
      settings: {
        relationType: RelationType.MANY_TO_ONE,
        onDelete: RelationOnDeleteAction.SET_NULL,
        joinColumnName: 'targetEmailMessageId',
      },
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
  ...
  targetFactory: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'targetFactory',
      label: i18nLabel(msg`Factory`),
      description: i18nLabel(msg`Favorite factory`),
      ...
      settings: {
        relationType: RelationType.MANY_TO_ONE,
        onDelete: RelationOnDeleteAction.SET_NULL,
        joinColumnName: 'targetFactoryId',
      },
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
  ...
  targetLicensorApprovalThread: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'targetLicensorApprovalThread',
      label: i18nLabel(msg`Licensor Approval Thread`),
      description: i18nLabel(msg`Favorite licensor approval thread`),
      ...
      settings: {
        relationType: RelationType.MANY_TO_ONE,
        onDelete: RelationOnDeleteAction.SET_NULL,
        joinColumnName: 'targetLicensorApprovalThreadId',
      },
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
  ...
  targetMeetingNote: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'targetMeetingNote',
      label: i18nLabel(msg`Meeting Note`),
      description: i18nLabel(msg`Favorite meeting note`),
      icon: 'IconNotes',
      isSystem: true,
      isNullable: true,
      isUIReadOnly: true,
      ...
      settings: {
        relationType: RelationType.MANY_TO_ONE,
        onDelete: RelationOnDeleteAction.SET_NULL,
        joinColumnName: 'targetMeetingNoteId',
      },
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
