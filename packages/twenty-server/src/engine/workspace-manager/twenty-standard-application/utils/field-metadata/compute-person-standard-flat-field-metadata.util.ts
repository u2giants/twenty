...
>): Record<AllStandardObjectFieldName<'person'>, FlatFieldMetadata> => ({
  ...
  scope: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      isNullable: true,
      options: [
        { id: '636ec59b-9558-4233-b163-ef4a765403f5', color: 'blue', label: 'Department', value: 'DEPARTMENT', position: 0 },
        { id: '055a8e14-f033-405a-8e8b-165ba94b525a', color: 'green', label: 'Company-Wide', value: 'COMPANY_WIDE', position: 1 },
        { id: '4a458fd8-0638-4d4c-8446-be551630f954', color: 'gray', label: 'Ignored', value: 'IGNORED', position: 2 },
      ],
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
  ...
  companyCustomerStatus: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      isUIReadOnly: true,
      options: [
        { id: 'e4c425d0-e7d7-4283-bffa-3150f98c080b', color: 'green', label: 'Active Customer', value: 'ACTIVE_CUSTOMER', position: 0 },
        { id: '31f0c589-8fc4-411a-98a4-4dae78dc8025', color: 'yellow', label: 'Potential Customer', value: 'POTENTIAL_CUSTOMER', position: 1 },
        { id: '79b1c54f-944a-4af0-9f9a-e8f8a15d6eef', color: 'gray', label: 'Other', value: 'OTHER', position: 2 },
      ],
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
